...
class EpisodeSelectionPanel extends StatefulWidget {
  ...
  /// Optional trailing adornment per episode row (e.g. local media badge).
  final Widget? Function(int episode, String name)? episodeTrailingBuilder;
                  ...
                  sliver: SliverList.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _EpisodeRow(
                        ...
                        disableAnimations: widget.disableAnimations,
                        trailing: widget.episodeTrailingBuilder
                            ?.call(episode, name),
                        onTap: () =>
